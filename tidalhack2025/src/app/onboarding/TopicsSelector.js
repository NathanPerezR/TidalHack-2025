...
const TopicsSelector = ({ onTopicsChange }) => {
  ...
  const topics = [
    "Music", "Sports", "Art", "Movies", "Travel", "Games",
    "Technology", "Science", "History", "Fashion", "Books", "Nature",
    "Photography", "Dance", "Theater", "Cooking", "Fitness", "Pets",
    "DIY", "Comedy", "Education", "Wellness", "Hackaton", "Greek Life", "Literature",
        ...
        <div className="flex flex-wrap gap-2 pb-1">
          {topics.map((topic) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm whitespace-nowrap transition-colors ${selectedTopics.includes(topic)
                ? "bg-black text-white"
